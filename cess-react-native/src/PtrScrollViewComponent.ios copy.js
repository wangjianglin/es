 ...
 * set of items.
 */
const PtrScrollViewComponent = React.createClass({
  propTypes: {
    ...View.propTypes,
         ...
         *   });
         */
        contentContainerStyle: View.propTypes.style,//StyleSheetPropType(ViewStylePropTypes),
        /**
        ...
        style: View.propTypes.style,//StyleSheetPropType(ViewStylePropTypes),
        /**
    ...
    */
    ...
    _scrollViewRef: (null: ?PtrScrollViewComponent),
        _setScrollViewRef: function(ref: ?PtrScrollViewComponent) {
