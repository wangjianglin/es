 ...
 */
@interface RCTPtrCustomScrollView : UIScrollView<UIGestureRecognizerDelegate>
...
@implementation RCTPtrCustomScrollView
{
...
- (UIView *)contentView
{
  return ((RCTPtrScrollView *)self.superview).contentView;
}
...
{
  if ([self _shouldDisableScrollInteraction] && ![[RCTUIManager JSResponder] isKindOfClass:[RCTPtrScrollView class]]) {
...
- (void)dockClosestSectionHeader
{
  ...
  [_stickyHeaderIndices enumerateIndexesWithOptions:0 usingBlock:
   ^(NSUInteger idx, BOOL *stop) {
    ...
    header.layer.zPosition = PTR_ZINDEX_DEFAULT;
  ...
  currentHeader.layer.zPosition = PTR_ZINDEX_STICKY_HEADER;
  ...
  if (previousHeader) {
    ...
    previousHeader.layer.zPosition = PTR_ZINDEX_STICKY_HEADER;
  }
}
...
- (instancetype)initWithEventDispatcher:(RCTEventDispatcher *)eventDispatcher
{
  ...
  if ((self = [super initWithFrame:CGRectZero])) {
    ...
    _scrollView = [[RCTPtrCustomScrollView alloc] initWithFrame:CGRectZero];
                       ...
                       userData:(NSDictionary *)userData
{
  ...
  RCTPtrScrollEvent *scrollEvent = [[RCTPtrScrollEvent alloc] initWithEventName:eventName
